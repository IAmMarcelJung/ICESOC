...
#include "../riscv_firmware_src/soc.h"
...
static inline void csr_wr_buf_uint8(unsigned long a, const uint8_t *buf,
                                    int cnt) {
...
static inline void csr_wr_buf_uint16(unsigned long a, const uint16_t *buf,
                                     int cnt) {
  _csr_wr_buf(a, buf, cnt);
}
...
static inline void csr_wr_buf_uint32(unsigned long a, const uint32_t *buf,
                                     int cnt) {
  _csr_wr_buf(a, buf, cnt);
}
...
static inline void csr_wr_buf_uint64(unsigned long a, const uint64_t *buf,
                                     int cnt) {
  _csr_wr_buf(a, buf, cnt);
}
